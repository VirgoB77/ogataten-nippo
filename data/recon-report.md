...
**まとめ: Excel 2件 / PDF 17件 / わからない 39件 / 表 45件**
...
- **この先を辿った: 25本** 
  ...
  -    令和5年度 新設の届出（法第5条第1項関係）について … **わからない** 2行×11列 PDF1本
...
- **この先を辿った: 3本** 
  ...
  -  能勢町の届出状況（別ウィンドウが開きます） … **わからない** 2行×7列 PDF1本
