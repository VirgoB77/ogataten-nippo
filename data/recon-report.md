# 大店立地法 届出ページ 偵察レポート（2026-09-18）

**まとめ: Excel 1件 / PDF 18件 / わからない 29件 / 表 52件**
...
- HTTP 200 / utf-8 / 34,702 バイト
- **判定: 表**
- 表 3 個 / PDFリンク 43 本 / Excel 0 本
- いちばん大きい表: 31 行 × 4 列
...
- robots.txt: 許可
- HTTP 200 / UTF-8 / 39,442 バイト
- **判定: 表**
- 表 12 個 / PDFリンク 19 本 / Excel 0 本
- いちばん大きい表: 45 行 × 5 列
  ...
  - PDF: 届出書（PDF：288KB） → https://www.city.kobe.lg.jp/documents/10974/todoke1154.pdf
  - PDF: 届出書（PDF：237KB） → https://www.city.kobe.lg.jp/documents/10974/todoke1153.pdf
- 出てきた言葉: 縦覧 / 届出
...
- **この先を辿った: 26本** 
  ...
  -    令和4年度 名称・代表者等の変更の届出（法第6条第1項関係）について … **表** 17行×8列
  ...
  -    既存店の変更の届出（法附則第5条第1項関係）について … **わからない**
  -    令和3年度 名称・代表者等の変更の届出（法第6条第1項関係）について … **表** 15行×8列
...
- robots.txt: 許可
- HTTP 200 / utf-8 / 17,322 バイト
- **判定: わからない**
- 表 0 個 / PDFリンク 2 本 / Excel 0 本
  - PDF: 縦覧リスト [PDFファイル／66KB] → https://www.city.kawachinagano.lg.jp/uploaded/attachment/48358.pdf
