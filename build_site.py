...
<dt>更新頻度</dt><dd>毎朝1回、自動で取り込んでいます。内容が変わっていれば、その日のうちに更新します。相手のサイトが決めている取り方の約束を守り、1日に2回以上は取りに行きません。兵庫県・神戸市の過去分（{esc(SITE_START)}より前の日付のもの）は、Internet Archive（Wayback Machine）に残っていた自治体ページの保存から積み直したもので、各ページにその旨を書いています。</dd>
